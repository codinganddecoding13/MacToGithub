...
print("If a 2000 pound pregnant hippo gives birth to a 100 pount calf.")
print("but then eats 50 pounds of food, how much does she weight?")
input("Press the enter key to find out.")
print("2000 - 100 + 50 =", 2000 - 100 + 50)

print("\nIf an adventurer returns form a successful quest and buys each of")
...
input("Pres the enter key to find out.")
print("19 / 4 =", 19/ 4)
