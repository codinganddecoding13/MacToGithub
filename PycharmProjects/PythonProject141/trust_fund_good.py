...
Please enter the requested, monthly costs. Since you're rich, ignore pennies and use ony dollar amounts.
...
staff = int(input("Staff (butlers, chef, driver, assistants): "))
